...
function App() {
  ...
  const requestObject = { url: `https://movie-base-3cbc2-default-rtdb.europe-west1.firebasedatabase.app/tasks.json` };
  ...
  useEffect(() => {
    ...
    // Last I shifted transform task declaration inside the useEffect() inorder to avoid making it an outside dependency and avoid useing useCallback extra time.
